...
export default tseslint.config(
  // `src/client` is generated by @hey-api/openapi-ts (see openapi-ts.config.ts);
  // don't hold generated code to handwritten-code rules.
  globalIgnores(["dist", "src/client"]),
  {
    ...
    rules: {
      ...
      // Remaining `any` lives in form/hook boundaries (e.g. useTableFilters,
      // admin-users create). The data layer is now fully typed via the
      // generated SDK, so this stays a warning rather than an error.
